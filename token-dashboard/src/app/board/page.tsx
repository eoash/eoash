  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <BoardFeed posts={posts} user={user} onDeleted={() => { setLoading(true); loadPosts(); }} onUpdated={() => { setLoading(true); loadPosts(); }} openPostId={openPostId} onLoginClick={() => setShowLogin(true)} />
      )}
    </div>
  );
}
