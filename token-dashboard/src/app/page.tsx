...
export default async function OverviewPage() {
  ...
  return (
    <div>
      ...
      {/* 스파이크 이슈 공지 배너 */}
      <div className="mb-6 rounded-lg border border-orange-500/30 bg-orange-500/10 px-4 py-3 flex items-center gap-3">
        <span className="text-orange-400 text-lg">⚠️</span>
        <span className="text-orange-300 text-sm">
          일별 토큰 사용량 차트에서 특정일이 과다 계상되는 스파이크 현상이 확인되어 수정 중입니다. 데이터가 정상화될 때까지 일부 수치가 부정확할 수 있습니다.
        </span>
      </div>
