      ...
      <div className="h-[380px] w-full">
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={data} margin={{ top: 5, right: 20, bottom: 5, left: 10 }}>
            ...
            <Bar dataKey="매출" fill="#34D399" name={t("income.chart.revenue")} radius={[4, 4, 0, 0]} barSize={40} />
            <Bar dataKey="판관비" fill="#FF6B6B" name={t("income.chart.expense")} radius={[4, 4, 0, 0]} barSize={40} />
            <Line
              type="monotone"
              dataKey="당기순이익"
              stroke="#00E87A"
