---
name: my-consult
description: EO Studio 어드바이저 자동 라우팅 메타 스킬. 입력 키워드를 감지해 Alex(코드), Lisa(법률), Chris(재무), Maya(여행) 중 적합한 어드바이저에게 자동 라우팅. "상담해줘", "물어볼게", "/consult" 요청에 사용.
---

# my-consult

입력 내용을 분석해 **Alex / Lisa / Chris / Maya** 중 가장 적합한 어드바이저에게 자동 라우팅하는 메타 스킬.
...
| 여행, travel, 여행지, 일정, 항공, 호텔, 숙소, 배낭여행, 투어, 관광, 휴가, 해외여행, 국내여행, 허니문, 맛집 여행, 비자 여행 | **Maya** | `agent/advisors/travel_advisor.md` |
